...
function InitFootball(){
	...
	proT = new createjs.Text("0","400 50px Kenyanrg","#000");
	stage.addChild(proT);
	
	//isMobile=true;
	if(window.innerWidth <= 1024){
		isMobile=true;
		var element = document.getElementById("mainb");
...
function showStartScreen(){
	...
	var vtitle = new createjs.Text("VS","50px Kenyanbd","#fff");
...
function gameIni(e){
	...
	var bname = "Gback";
 	...
 	var gBack = addBmp(bname,0,-50,false);
	...
	bArrow.x =  stWidth/2;
	bArrow.y =  650;
	powerT = new createjs.Text("0","30px Kenyanrg","#000");
...
if(!isGame){
	ballStart(Ball,150,300,stWidth/2,300,500,750,0);
...
function divePlayer(){
	...
	if(teamNo == 2){
		...
		//srand =0;
		if(srand == 0){
			playerDiveT(playerPmc,500,650,730,220,320,500,25,50,90,0);
		}else{
		
			playerDiveT(playerPmc,300,300,150,220,320,500,-25,-50,-90,0);
		}
	...
	if(teamNo == 1){
		...
		if(srand == 0){
			playerDiveT(playerCnc,500,650,730,220,320,500,25,50,90,0);
		}else{
		
			playerDiveT(playerCnc,300,200,150,220,320,500,-25,-50,-90,0);
		}
...
isDive = true;
	...
	Ball.x = -200;
	Ball.y = 200;
	ballStart(Ball,100,300,stWidth/2,300,500,750,0);
	Pball.alpha =0;
	Ball.alpha =1;
